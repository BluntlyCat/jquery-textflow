...
k()},E=function(e,b,l,p,d,h,g,m,n,c){var a=this,q=null,f=800>=window.innerWidth?12:16,k=800>=window.innerWidth?16:20,v=function(){if(l.getElements().length<n){var d=t(f,k),h=c[t(c.length)],g,m=t(1,10)*b.x;p.txtCtx.font=d+"pt "+e.font;g=p.txtCtx.measureText(h).width;d=new D(e,0>b.x?a.width:-g,t(a.marginTop,a.height-a.marginBottom-a.marginTop-d),g,d,m,b,l,h,d);l.addElement(d);d.start()}q=setTimeout(v,t(1E3,2500))};this.width=d;this.height=h;this.marginTop=g;this.marginBottom=m;this.resize=function(c,
f){a.width=c;a.height=f};this.start=function(){v()};this.stop=function(){clearTimeout(q)}},F=function(e,b,l,p,d,h,g){var m=this,n=u("<canvas></canvas>"),c=n[0].getContext("2d"),a=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame,q=window.cancelAnimationFrame||window.mozCancelRequestAnimationFrame||window.webkitCancelRequestAnimationFrame||window.msCancelRequestAnimationFrame||window.oCancelRequestAnimationFrame,
...
h[b],d!==c&&a.push(d);h=a;g=[];for(b=0;b<h.length;b++)d=h[b],g.push(d)};this.getElements=function(){return g};this.resize=function(b,a){p.width=b;p.height=a};this.start=function(){n()};this.stop=function(){clearTimeout(d)}},r=null,w=null,z=null,y=!1,B=function(){y||(r.start(),w.start(),z.start(),y=!0)},C=function(){y&&(r.stop(),w.stop(),z.stop(),y=!1)};u.fn.startTextFlow=function(){B()};u.fn.stopTextFlow=function(){C()};u.fn.textFlow=function(e){var b=u(this),l=null,p=null,d=u.extend({width:"100%",
...
l,w,r,r.size().width,r.size().height,d.marginTop,d.marginBottom,d.maxTexts,p);b.startTextFlow()})();window.onresize=function(){r.resize();w.resize(b.outerWidth(),b.outerHeight());z.resize(r.size().width,r.size().height)};document.addEventListener("visibilitychange",function(){y?C():B()});return this}})(jQuery);
